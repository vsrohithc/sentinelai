...
We as members, contributors, and maintainers pledge to make participation in the SentinelAI community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all community spaces — issues, pull requests, discussions, the project's social media accounts, and at any in-person or online event where contributors are representing the project.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainers via a **GitHub Private Security Advisory** (the same private channel used for security reports — see [SECURITY.md](SECURITY.md)) or by email to the maintainer listed in [CODEOWNERS](.github/CODEOWNERS).
